...
import xyz.srclab.ship.properties.EncodeString.Companion.parseEncodeString
import java.beans.PropertyEditorSupport
import java.nio.charset.Charset

/**
 * Represents a value after a serials codec operation.
 */
open class EncodeString {
    ...
    companion object {
         ...
         * ```
         * will be decode value as: `some password`
         */
        @JvmName("parse")
        @JvmStatic
